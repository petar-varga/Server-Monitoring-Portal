...
from core.secret_data_loading import MYSQL_DATABASE_ENV, MYSQL_PASSWORD_ENV, MYSQL_SERVER_ENV, MYSQL_USERNAME_ENV
...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: List[AnyHttpUrl] = ["http://localhost", "http://localhost:4200", "http://localhost:3000", "http://localhost:8080"]
